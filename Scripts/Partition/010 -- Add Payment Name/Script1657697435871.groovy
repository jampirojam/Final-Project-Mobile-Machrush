...
Mobile.setText(findTestObject('Object Repository/Payment/android.widget.EditText - Payee Name'), 'Kuda', 0)

Mobile.tap(findTestObject('Object Repository/Payment/android.widget.Button - ADD'), 0)
/*
Mobile.setText(findTestObject('Object Repository/Payment/android.widget.EditText - Amount'), '5433', 0)
