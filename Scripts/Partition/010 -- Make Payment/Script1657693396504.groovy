...
Mobile.tap(findTestObject('Object Repository/Payment/android.widget.CheckedTextView - Accounts'), 0)
...
Mobile.setText(findTestObject('Object Repository/Payment/android.widget.EditText - Payee Name'), 'Aliy', 0)

Mobile.tap(findTestObject('Object Repository/Payment/android.widget.Button - ADD'), 0)

Mobile.setText(findTestObject('Object Repository/Payment/android.widget.EditText - Amount'), '1234', 0)
